...
% READ DATA:
directory = 'VGOSWECwaveenergyprize/VGM90/'; 
file = 'all';
...
VGM90 = OSWEC_regularwaves_pre(VGM90,regularwaves_pre_opts,t0,tf,fs,plotloop,verbose);
...
waveenergyprize_VGM90 = OSWEC_regularwaves_post(VGM90,regularwaves_post_opts,plotloop,verbose);
